...
![Search option in blue sidebar.](img/search1.png)
...
![Close up on the search options, showing the expanded ellipses menu with selection options for Items, Item Sets, or Media.](img/search2.png)
...
![Advanced search button indicated with a red arrow.](img/advancedsearch2.png)
...
![Advanced item search options page.](img/advancedsearch3.png)
...
![Advanced search button indicated with a red arrow.](img/search_mediaadvance1.png)
...
![Advanced media search options form, with fields as described above.](img/search_mediaadvance2.png)
...
![Advanced search button indicated with a red arrow.](img/advancedsearchis1.png)
...
![Advanced item set search options form, with fields as described above.](img/advancedsearchis2.png)
...
![Homepage of the Jane Austen site, with a blue arrow pointing to the search bar below the main navigation menu](img/search_public1.png)
...
![Search results for "Cassandra" showing one page and three items](img/search_public2.png)
...
![The Items page of the Jane Austen site, with a blue arrow pointing to the link for Advanced search](img/search_publicitems1)
...
![Advanced item search fields as described](img/search_publicitems2)
...
![Item sets page for the Jane Austen site. A blue arrow points to the advanced search link](img/search_publicitemsets1.png)
...
![Item set advanced search options as described](img/search_publicitemsets2.png)
