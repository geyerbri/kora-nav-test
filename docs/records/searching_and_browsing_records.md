...
3. This will bring you to the *Project Records Search* page. You may search for a particular record using the *Search Via Keyword(s) or KID* search bar. <p align="center"> <img src="../records-img/searching_and_browsing_records_11_annotated.png" width="100%" style="align:center" title="Step 11"> </p> </p>
...
1. Navigate to the form home page. From here you may start searching for records by either pressing the **Form Record & Search()** button or one of the menu options. <p align="center"> <img src="../records-img/searching_and_browsing_records_14_annotated.png" width="100%" style="align:center" title="Step 14"> </p>
