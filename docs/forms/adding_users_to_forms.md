...
The **edit form info** button will take you to the [Edit Form](content/navigating_to_a_form.md) page where you can press **Go to Form Permissions Page** add additional users to a form and create new permission groups. <p align="center"> <img src="../forms-img/adding_users_to_forms_2_annotated.png" width="100%" style="align:center" title="Step 2"> </p>

From the *Form Permissions* page, you can follow these steps to add new users to a permissions group for a form:

1. The **Admin Group** will be the first block in the *Form Permissions* page. If you want a fuller explanation on how to handle admins, then check out the [documentation on form administrators](content/additional_form_administrators.md). Below the admin block is the **Default Group** block where new users with new permissions can be added. Click on **Default Group** to open it up. <p align="center"> <img src="../forms-img/adding_users_to_forms_3_annotated.png" width="100%" style="align:center" title="Step 3"> </p>
...
You are able to select particular form permissions for users by checking the boxes next to the permissions located in permissions groups. The options allow you to stop certain users from [creating](content/creating_fields.md), [editing](content/editing_fields.md), or deleting fields while still giving them the ability to [create](content/creating_a_record.md), [edit](content/editing_a_record.md) or delete records. Any combination of these permissions are available. <p align="center"> <img src="../forms-img/adding_users_to_forms_13_annotated.png" width="100%" style="align:center" title="Step 13"> </p>
