...
You are able to select particular form permissions for users by checking the boxes next to the permissions located in permissions groups. The options allow you to stop certain users from [creating](../forms/creating_fields.md), [editing](../forms/editing_fields.md), or deleting fields while still giving them the ability to [create](../records/creating_a_record.md), [edit](../records/editing_a_record.md) or delete records. Any combination of these permissions are available. <p align="center"> <img src="../forms-img/adding_users_to_forms_13_annotated.png" width="100%" style="align:center" title="Step 13"> </p>
